        ...
        <section className="px-6 py-16 md:py-20 bg-adopet-primary">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-lg text-white/90 mb-8">
              Baixe grátis na Google Play ou na App Store e comece a anunciar ou adotar pets hoje mesmo.
            </p>
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4 flex-wrap">
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                onClick={() => trackAppStoreClick('apoie')}
                className="inline-flex items-center justify-center gap-2 px-10 py-4 rounded-2xl bg-white text-adopet-text-primary font-semibold text-lg shadow-xl hover:bg-white/95 transition-all hover:scale-[1.02] active:scale-[0.98]"
              >
                <svg className="w-7 h-7" viewBox="0 0 24 24" fill="currentColor" aria-hidden>
