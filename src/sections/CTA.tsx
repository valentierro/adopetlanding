      ...
      <div className="max-w-3xl mx-auto text-center">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4 flex-wrap">
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            onClick={() => trackAppStoreClick('cta_section')}
            className="inline-flex items-center justify-center gap-2 px-10 py-4 rounded-2xl bg-white text-adopet-text-primary font-semibold text-lg shadow-xl hover:bg-white/95 transition-colors hover:scale-[1.02] active:scale-[0.98]"
          >
            <svg className="w-7 h-7" viewBox="0 0 24 24" fill="currentColor" aria-hidden>
